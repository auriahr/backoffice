...
const consultations = [
  { id: "LEG-001", company: "Tech Solutions S.L.", subject: "Despido procedente", priority: "high", status: "in-review" },
  { id: "LEG-002", company: "Retail Group", subject: "Revisión contrato mercantil", priority: "medium", status: "completed" },
];

export function LegalConsultations() {
  return (
        ...
        <Dialog>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button className="bg-primary hover:bg-primary/90">Crear Consulta</Button>
            </div>
          </DialogContent>
        </Dialog>
      </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-3">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    <span className="font-mono text-sm text-muted-foreground">{consultation.id}</span>
                    <Badge className={consultation.priority === "high" ? "bg-red-100 text-red-700" : "bg-yellow-100 text-yellow-700"}>
                ...
                <div className="flex items-center gap-2">
                  <Badge className={consultation.status === "in-review" ? "bg-blue-100 text-blue-700" : "bg-green-100 text-green-700"}>
                    {consultation.status === "in-review" ? "En Revisión" : "Completada"}
                  </Badge>
